    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telnmbr', models.DecimalField(decimal_places=0, max_digits=11, verbose_name='Номер телефона')),
                ('adres', models.CharField(blank=True, max_length=250, null=True, verbose_name='Адрес доставки')),
